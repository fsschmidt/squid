...
$DIALOG --item-help --backtitle "Administracao do servidor PROXY - Improve Consultoria e Informatica - http://www.improve.inf.br" --title "Aplicativos bloqueados - $VERSAO - BOZI" --menu "Menu para administracao do servidor proxy SQUID" 15 90 2 \
"WEBMSN" "Sites de acesso ao MSN" "Sites para acesso ao WEB MSN" \
"SKYPE" "Software SKYPE" "Software Skype" 2>/tmp/menuitem.$$
##
...
opt=$?
case $menuitem in
"WEBMSN") mcedit $SITES/webmsn.txt;$APLADM;;
"SKYPE")  mcedit $SITES/skype.txt;$APLADM;; 
esac
##
